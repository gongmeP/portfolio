<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
String titles = "합리적인 쇼핑몰 [BEST SHOP]";
%>
<!doctype html>
<html lang="ko">
<head>
...
<script defer="defer" src="./static/js/main.4dd6564b.js"></script>
...
<body id="main_all">
	...
	<main class="main_css">
		...
		<section class="new_pro_css">
			<div id="new_pro"></div>
		</section>
		<article class="AD_css">
			<div id="ad1"></div>
		</article>
		<article class="MD_css">
			<div id="md"></div>
		</article>
		<section class="tran_css">
			<div id="tran"></div>
		</section>
		<article class="AD_css">
			<div id="ad2"></div>
