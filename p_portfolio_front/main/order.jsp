...
적립금 사용 : <input type="text" name="point" value="0" readonly="readonly"> <br>
<p>------------결제파트--------------------</p>
<input type="radio" name="gopaymethod" value="CARD" checked="checked"> 신용카드 <br>
<input type="radio" name="gopaymethod" value="Directbank"> 계좌이체 <br>
<input type="radio" name="gopaymethod" value="vbank"> 가상계좌 <br>
<button type="button" id="payment">결제하기</button> <br>
